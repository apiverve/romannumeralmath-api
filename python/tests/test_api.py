...
class TestRomannumeralmathAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RomannumeralmathAPIClient(self.api_key)

    @patch('apiverve_romannumeralmath.apiClient.requests.get')
