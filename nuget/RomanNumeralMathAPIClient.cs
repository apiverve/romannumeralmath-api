...
namespace APIVerve.API.RomanNumeralMath
{
    ...
    /// <summary>
    /// Client for the RomanNumeralMath API
    /// </summary>
    public class RomanNumeralMathAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/romannumeralmath";
        ...
        {
            { "roman1", new ValidationRule { Type = "string", Required = true } },
            { "roman2", new ValidationRule { Type = "string", Required = true } },
            { "operation", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public RomanNumeralMathAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RomanNumeralMathAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RomanNumeralMathAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RomanNumeralMathQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RomanNumeralMathQueryOptions options)
        {
        ...
        public ResponseObj Execute(RomanNumeralMathQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RomanNumeralMathQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RomanNumeralMathQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RomanNumeralMathQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RomanNumeralMathQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RomanNumeralMathQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RomanNumeralMathQueryOptions options)
        {
