...
class romannumeralmathWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/romannumeralmath');
        }
        ...
        this.validationRules = {"roman1":{"type":"string","required":true},"roman2":{"type":"string","required":true},"operation":{"type":"string","required":false,"default":"add"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/romannumeralmath`);
        }
    }
...
module.exports = romannumeralmathWrapper;
