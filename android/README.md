# Roman Numeral Math Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:romannumeralmath-api:1.1.12'
}
```
...
```java
import com.apiverve.romannumeralmath.RomanNumeralMathAPIClient;
import com.apiverve.romannumeralmath.APIResponse;
import com.apiverve.romannumeralmath.APIException;

// Initialize the client
RomanNumeralMathAPIClient client = new RomanNumeralMathAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/romannumeralmath](https://docs.apiverve.com/ref/romannumeralmath)
...
- **Documentation:** [https://docs.apiverve.com/ref/romannumeralmath](https://docs.apiverve.com/ref/romannumeralmath)
- **Issues:** [GitHub Issues](https://github.com/apiverve/romannumeralmath-api/issues)
