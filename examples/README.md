# Roman Numeral Math API - Examples

This folder contains example code for using the Roman Numeral Math API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/romannumeralmath',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/romannumeralmath");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/romannumeralmath](https://docs.apiverve.com/ref/romannumeralmath)
