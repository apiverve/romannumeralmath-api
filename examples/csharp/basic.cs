...
{
    class RomanNumeralMathExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/romannumeralmath";

        /// <summary>
        /// Make a GET request to the Roman Numeral Math API
        /// </summary>
        static async Task<JsonDocument> CallRomanNumeralMathAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;roman1&quot;] &#x3D; &quot;XIV&quot;, [&quot;roman2&quot;] &#x3D; &quot;VI&quot;, [&quot;operation&quot;] &#x3D; &quot;add&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Roman Numeral Math API...\n");

            var result = await CallRomanNumeralMathAPI();
