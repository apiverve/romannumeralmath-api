// Package romannumeralmath provides a Go client for the Roman Numeral Math API.
//
// For more information, visit: https://apiverve.com/marketplace/romannumeralmath?utm_source=go&utm_medium=readme
package romannumeralmath
...
// Request contains the parameters for the Roman Numeral Math API.
//
// Parameters:
//   - roman1 (required): string - The first Roman numeral
//   - roman2 (required): string - The second Roman numeral
//   - operation: string - Operation to perform
type Request struct {
	Roman1 string `json:"roman1"` // Required
	Roman2 string `json:"roman2"` // Required
...
// ResponseData contains the data returned by the Roman Numeral Math API.
type ResponseData struct {
	Roman1 string `json:"roman1"`
	Roman2 string `json:"roman2"`
	Roman1Value int `json:"roman1_value"`
	Roman2Value int `json:"roman2_value"`
	Operation string `json:"operation"`
	ResultNumber int `json:"result_number"`
	ResultRoman string `json:"result_roman"`
	EquationNumeric string `json:"equation_numeric"`
	EquationRoman string `json:"equation_roman"`
}
