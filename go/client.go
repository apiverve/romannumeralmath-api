...
const (
	baseURL        = "https://api.apiverve.com/v1/romannumeralmath"
	defaultTimeout = 30 * time.Second
)

// Client is the Roman Numeral Math API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Roman Numeral Math API client.
...
// Execute makes a request to the Roman Numeral Math API with typed parameters.
//
